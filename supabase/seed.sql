...
('760dcc34-df32-4473-96bd-fa021c401837', 'hero', '首屏Hero', 1,
...
('760dcc34-df32-4473-96bd-fa021c401837', 'about', '关于我们', 2,
 '{"title": "精于专业 · 恪于安全 · 诚于客户", "subtitle": "核医学一站式服务领航者", "features": [{"icon": "fa-drafting-compass", "text": "工艺设计/专项施工图"}, {"icon": "fa-hard-hat", "text": "辐射防护施工/三废处理"}, {"icon": "fa-chart-line", "text": "智慧核医学管理系统"}, {"icon": "fa-hand-holding-heart", "text": "7×24h运维检测"}]}'::jsonb);

-- 4. 服务概览和服务详情区块
INSERT INTO blocks (page_id, type, title, sort_order, config) VALUES
('760dcc34-df32-4473-96bd-fa021c401837', 'services', '服务概览', 3,
 '{"title": "核医学场所 · 全生命周期解决方案", "subtitle": "闭环服务", "cards": [{"id": "design", "icon": "fa-pencil-ruler", "title": "设计", "subtitle": "选址评估 · 布局优化 · 辐射分区", "features": ["符合GBZ、药品GMP及放射性药品附录", "衰变池设计/辐射防护优化", "药监验收一站式技术咨询"]}, {"id": "construction", "icon": "fa-hard-hat", "title": "施工", "subtitle": "辐射防护施工 · 放射性废水处理系统", "features": ["防护门窗/围护结构/三废处理", "通过环保验收、职卫控评验收", "智能衰变池系统（长短半衰期双系）"]}, {"id": "equipment", "icon": "fa-microscope", "title": "设备", "subtitle": "核素治疗监测 · 辐射监测仪器", "features": ["131I体内活度测量/全身动态辐射显像", "个人剂量仪/环境监测/活度计CRC-55tR", "放射性废物自动处理系统"]}], "detailLinks": [{"id": "service-design", "text": "设计 · 规划布局", "icon": "fa-pencil-ruler"}, {"id": "service-construction", "text": "施工 · 辐射防护", "icon": "fa-hard-hat"}, {"id": "service-equipment", "text": "设备 · 监测仪器", "icon": "fa-microscope"}, {"id": "service-software", "text": "瑞核V1.0智慧系统", "icon": "fa-chart-line"}]}'::jsonb),
('760dcc34-df32-4473-96bd-fa021c401837', 'service-detail', '设计篇', 4,
 '{"id": "service-design", "badge": "精准设计 · 合规先行", "title": "全流程核医学专项设计", "description": "从选址评估到施工图落地，贝瑞设计团队严格遵循药品GMP、GBZ系列及放射性药品附录，为客户提供功能优化与成本可控的专项设计。"}'::jsonb),
('760dcc34-df32-4473-96bd-fa021c401837', 'service-detail', '施工篇', 5,
 '{"id": "service-construction", "badge": "匠心施工 · 全程可控", "title": "辐射防护与净化工程总承包", "description": "多工种交叉协同，驻点管理确保进度与质量。辐射防护门窗、围护结构、三废处理系统一次性通过环保验收及职业病危害控制效果评价。", "features": [{"icon": "fa-shield-virus", "text": "防护门窗/铅玻璃/防护涂料施工，满足环评卫评要求"}, {"icon": "fa-water", "text": "智能放射性废水衰变系统（长短半衰期双系）达标排放"}, {"icon": "fa-chart-line", "text": "放射性药物制备净化场所施工，通过药监GMP专家检查"}, {"icon": "fa-clock", "text": "全程项目管理 + 7×24h运维保障，无缝衔接验收"}]}'::jsonb),
('760dcc34-df32-4473-96bd-fa021c401837', 'service-detail', '设备篇', 6,
 '{"id": "service-equipment", "badge": "尖端设备 · 智慧监测", "title": "核素治疗及辐射监测仪器", "description": "提供从放射性药物操作、分装到患者治疗监测、环境辐射安全的完整设备链，助力核医学科高效合规运行。", "features": [{"icon": "fa-syringe", "text": "I-131体内活度测量系统 / 全身动态辐射显像（Clairvoyant2）"}, {"icon": "fa-radiation", "text": "RadTarge个人剂量仪、RadWal环境辐射监测仪、便携式巡测仪"}, {"icon": "fa-cube", "text": "防护手套箱、合成热室、分装热室、一体化注射防护台"}, {"icon": "fa-flask", "text": "CRC-55tR活度计 / 全自动脚踏式放射性废物箱 / 转运防护罐"}]}'::jsonb),
('760dcc34-df32-4473-96bd-fa021c401837', 'service-detail', '瑞核系统', 7,
 '{"id": "service-software", "badge": "数字孪生 · 智慧中枢", "title": "瑞核V1.0 核医学智慧管理系统", "description": "1中心+2平台+4维度+N应用，实现设备运行、辐射安全、安防、日常运营全维度管理。物理空间1:1虚拟映射，数据驱动主动预判。", "features": [{"icon": "fa-chart-simple", "text": "实时辐射监测预警 & 智能决策辅助"}, {"icon": "fa-database", "text": "设备生命周期管理与预测维护"}, {"icon": "fa-shield-alt", "text": "符合核医学质控及监管上报标准"}]}'::jsonb);

-- 5. 优势、案例、新闻、联系、CTA区块
INSERT INTO blocks (page_id, type, title, sort_order, config) VALUES
('760dcc34-df32-4473-96bd-fa021c401837', 'advantages', '核心优势', 8,
...
('760dcc34-df32-4473-96bd-fa021c401837', 'projects', '业绩案例', 9,
