...
export const serviceDesign: ServiceItem = {
  ...
  image: getServiceDetail('service-design').image || '/berry-medical-web/images/services/design.jpg',
...
export const serviceConstruction: ServiceItem = {
  ...
  image: getServiceDetail('service-construction').image || '/berry-medical-web/images/services/construction.jpg',
...
export const serviceEquipment: ServiceItem = {
  ...
  image: getServiceDetail('service-equipment').image || '/berry-medical-web/images/services/equipment.jpg',
...
export const serviceSoftware: ServiceItem = {
  ...
  image: getServiceDetail('service-software').image || '/berry-medical-web/images/services/software.jpg',
